...
;*******************************************************************************
 ; CONFIG1
  ...
  CONFIG MCLRE = OFF ; ((PORTE) and 07Fh), 3/MCLR pin function select bit
...
BANKSEL OSCCON
    ...
    BSF OSCCON, 6 ; ((OSCCON) and 07Fh), 6 Selección de 2 MHz
...
BANKSEL OPTION_REG ;TEMPORIZADOR DEL TMR0
    ...
    BSF OPTION_REG, 2
    BSF OPTION_REG, 1
    BSF OPTION_REG, 0 ; ((OPTION_REG) and 07Fh), 2 -0: PRESCALER 1:256 SELECIONADO
...
LOOP:
    ...
    BTFSC PORTA, 1 ; Revisa ((PORTA) and 07Fh), 1
    CALL anti2
    BTFSS PORTA, 1
    CALL push2
    movwf contdisplay, F
...
verificaciontmr:
    BTFSS INTCON, 2 ; Verificamos si la bandera ((INTCON) and 07Fh), 2 = 1?
    GOTO $-1
    BCF INTCON, 2 ; Borramos la bandera ((INTCON) and 07Fh), 2
    MOVLW 61
    MOVWF TMR0
    INCF cont1s, F
    call verificacion
